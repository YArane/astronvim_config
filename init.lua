...
local config = {
        ...
        mappings = {
                ...
                n = {
                        ...
                        ["<C-x>"] = { function() astronvim.close_buf(0) end, desc = "Close buffer" },
                        ["<S-Left>"] = { function() astronvim.nav_buf(vim.v.count > 0 and vim.v.count or 1) end, desc = "Next buffer" },
                        ["<S-Right>"] = { function() astronvim.nav_buf( -(vim.v.count > 0 and vim.v.count or 1)) end, desc = "Previous buffer" },
                        ...
                        ["<leader>hr"] = { function() require("harpoon.mark").remove_file() end, desc = "Harpoon remove file" },
        ...
        luasnip = {
                ...
                vscode = {
                        -- Add paths for including more VS Code style snippets in luasniplspkind
                        paths = {},
                },
        },
